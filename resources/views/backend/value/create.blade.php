    ...
    <main id="main" class="main">
        <div class="d-flex justify-content-between">
            ...
            <div class="text-end pt-2">
                <a href="{{ route('value.index') }}" class="btn btn-primary"><i class="fa-regular fa-eye"></i>
                    View
                    Attributes Value</a>
            </div>
        </div>
        <hr>
        <div class="card">
            <form method="post" action="{{ route('value.store') }}" encattributes="multipart/form-data" class="row g-3 p-3">
                @csrf
                ...
                <div class="col-md-12 pb-3">
                    <label for="attributes_id" class="form-label">Attributes Value<span class="text-danger">*</span></label>
