    ...
    <main id="main" class="main">
        <div class="d-flex justify-content-between">
            ...
            <div class="text-end pt-2">
                <a href="{{ route('stock.index') }}" class="btn btn-primary"><i class="fa-regular fa-eye"></i>
                    View
                    Stock</a>
            </div>
        </div>
        <hr>
        <div class="card">
            <form method="post" action="{{ route('stock.update', $product->id) }}" enctype="multipart/form-data"
                class="row g-3 p-3">
                @csrf
                @method('PUT')
